def solve_party_transport(n, c, l, friends, cars):
    ...
    for region in regions:
        sober = len(regions[region]['S'])  # 안 취한 사람 수
        drunk = len(regions[region]['I'])  # 취한 사람 수
        ...
        for seats in available_cars:
            ...
            # 이 차에 탑승하는 총 인원 누적
            people_can_go += drunk_in_car + sober_in_car + 1  # +1은 운전자
...
def process_test_cases():
    ...
    for i in range(1, K + 1):
        ...
        # 결과 출력
        result = solve_party_transport(n, c, l, friends, cars)
        print(f"Data Set {i}:")
        print(result)
